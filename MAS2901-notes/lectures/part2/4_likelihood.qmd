...
Here we treat $\theta$ as the **variable**, and \$\underline{x}\$ as fixed.
:::


**Key contrast:**

* Probability/density: function of $\underline{x}$ (data random, parameter fixed).
* Likelihood: function of $\theta$ (data fixed, parameter variable).

---

:::{.example #exm-bernoulli}
...
::: {.worked-example #ex-bern-likelihood}
**Worked example.**
