...
```{ojs}
dynamicPlotW = Math.min(400, width)
```
...
html`<div class="ojs-figure-shell">
  <div class="ojs-plot-grid" style="gap:${gap}px;">
    ...
    <div class="ojs-plot-panel">
      <div class="ojs-plot-title" style="font-weight:600; font-size:15px;">Binomial PMF</div>
      ${pmfPlot}
    </div>
    
    <div class="ojs-plot-panel">
      <div class="ojs-plot-title" style="font-weight:600; font-size:15px;">Likelihood Function</div>
      ${likelihoodPlot}
    </div>
