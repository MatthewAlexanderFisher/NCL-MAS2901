...
viewof muVar2D = {
  ...
  // Initial value
  let state = {
    // Start from a neutral guess rather than revealing the generating values.
    approxMu: clamp(0, mu_min, mu_max),
    approxVar: clamp(1, var_min, var_max)
  };
...
{
  const wrap = html`<div class="inference-by-eye-layout" style="
    display: grid;
...
viewof controls = {
  ...
  const root = html`<details class="controls-root">
    <summary>Reveal simulation controls and true values</summary>
    <div class="controls-grid">
      <div class="controls-col"><h4>Data-generating values</h4></div>
