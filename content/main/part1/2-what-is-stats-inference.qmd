...
::: {.callout-tip title="Checkpoint: identify the ingredients"}
...
::: {.callout-tip title="Checkpoint: classify before modelling"}
...
::: {.callout-tip title="Checkpoint: question the model"}
