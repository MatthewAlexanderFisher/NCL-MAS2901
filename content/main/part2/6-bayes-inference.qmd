...
Bayesian updating combines a likelihood shared with frequentist inference and an explicit prior. Conjugacy makes some updates algebraic, but prior strength, parameter support, and model assumptions still require interpretation. A posterior is the main inferential output; its mean, median, and mode answer different decision questions, and large samples often—but not always—reduce prior influence.
:::
