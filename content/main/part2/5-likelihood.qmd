...
## Learning objectives and route through this chapter
...
::: {.callout-tip appearance="simple"}
### Chapter summary and checkpoint

Starting from a model, the route is
$$
...
$$
At each arrow, check what is fixed, the parameter space, and whether the result is exact or asymptotic. For the Bernoulli model, explain why $\bar Y$ is simultaneously an unbiased estimator and the MLE, while still being a random quantity before the data are observed.
:::
