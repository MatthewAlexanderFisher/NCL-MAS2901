...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solution}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Learning objectives}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Note on this section}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Note on Statistical Models}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Notation rule}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Likelihood vs.~Probability:}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colframe=quarto-callout-important-color-frame, toprule=.15mm, breakable, bottomrule=.15mm, left=2mm, arc=.35mm, opacityback=0, rightrule=.15mm, leftrule=.75mm]
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{lectures/part2/6-bayes-inference_files/figure-pdf/unnamed-chunk-2-1.pdf}}
\end{center}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{lectures/part2/6-bayes-inference_files/figure-pdf/unnamed-chunk-3-3.pdf}}
\end{center}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{lectures/part2/6-bayes-inference_files/figure-pdf/unnamed-chunk-4-1.pdf}}
\end{center}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{lectures/part2/6-bayes-inference_files/figure-pdf/unnamed-chunk-6-3.pdf}}
\end{center}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{lectures/part2/6-bayes-inference_files/figure-pdf/unnamed-chunk-7-5.pdf}}
\end{center}
...
\section{One Observed Sample}\label{one-observed-sample}

In practice, we only ever observe one dataset \(\underline{x}\). So we
calculate the observed interval: \[
[L_{\text{obs}}, U_{\text{obs}}] 
= \big[L(\underline{x}), U(\underline{x})\big].
\]

\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Confidence Interval Interpretation}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
Exact confidence intervals are not always available. When possible, we
aim for \textbf{well-calibrated} (exact coverage) intervals; otherwise,
we use \textbf{approximate intervals} (e.g.~via the Central Limit
Theorem).

However, there are a few cases where we can compute closed-form
\textbf{well-calibrated} confidence intervals:
...
\item
  ...
  \]
\item
  From quantiles of the standard normal, we obtain the \((1-\alpha)\)
  confidence interval:
...
If \(\sigma^2\) is unknown, replace it by the sample variance \(S^2\).
Then
...
For many distributions (not just normal), the \textbf{Central Limit
Theorem (CLT)} tells us that

\[
\frac{\hat{\theta} - \theta}{\text{SE}(\hat{\theta})} \approx \mathcal{N}(0,1)
\]

for large \(n\), where \(\text{SE}(\hat{\theta})\) is the standard
error.
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, arc=.35mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, breakable, bottomrule=.15mm, rightrule=.15mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, coltitle=black, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, opacityback=0, arc=.35mm, leftrule=.75mm]
